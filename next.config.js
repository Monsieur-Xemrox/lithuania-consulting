...
const config = {
  ...
  // This will allow WordPress static export
  output: process.env.WORDPRESS_EXPORT === 'true' ? 'export' : undefined,
  // Add assetPrefix for WordPress integration when in export mode
  assetPrefix: process.env.WORDPRESS_EXPORT === 'true' ? './' : undefined,
  eslint: {
